...
class RasaModelData:
    ...
    def split(
        ...
        """Create random hold out test.csv set using stratified split.

        Args:
            number_of_test_examples: Number of test.csv examples.
            random_seed: Random seed.

        Returns:
            A tuple of train and test.csv RasaModelData.
        """
        ...
        if self.label_key is None or self.label_sub_key is None:
            ...
            # we perform stratified train test.csv split,
            # which insures every label is present in the train and test.csv data
    ...
    def _check_train_test_sizes(
        ...
        """Check whether the test.csv data set is too large or too small.
    ...
    def _convert_train_test_split(
        ...
        Returns:
            The test.csv and train RasaModelData
        """
