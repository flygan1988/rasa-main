...
def test(
    ...
    """Test a Rasa model against a set of test.csv data.

    Args:
        model: model to test.csv
        stories: path to the dialogue test.csv data
        nlu_data: path to the NLU test.csv data
        output: path to folder where all output will be stored
        additional_arguments: additional arguments for the test.csv call
    """
