...
def add_subparser(
    ...
    test_parser = subparsers.add_parser(
        ...
        help="Tests Rasa models using your test.csv NLU data and stories.",
    )
    ...
    test_core_parser = test_subparsers.add_parser(
        ...
        conflict_handler="resolve",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
        help="Tests Rasa Core models using your test.csv stories.",
    )
    ...
    test_nlu_parser = test_subparsers.add_parser(
        ...
        parents=parents,
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
        help="Tests Rasa NLU models using your test.csv NLU data.",
    )
...
async def run_core_test_async(args: argparse.Namespace) -> None:
    ...
    if args.model is None:
        rasa.shared.utils.cli.print_error(
            ...
            "the model to test.csv with '--model'."
        )
        return
...
async def run_nlu_test_async(
    ...
    Args:
        ...
        cross_validation: indicates if it should test.csv the model using cross validation
                          or not.
...
def run_nlu_test(args: argparse.Namespace) -> None:
    ...
    Args:
        args: the parsed CLI arguments for 'rasa test.csv nlu'.
    """
...
def run_core_test(args: argparse.Namespace) -> None:
    ...
    Args:
        args: the parsed CLI arguments for 'rasa test.csv core'.
    """
