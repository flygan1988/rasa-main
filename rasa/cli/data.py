...
def _add_data_split_parsers(
    ...
    split_parser = data_subparsers.add_parser(
        ...
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
        parents=parents,
        help="Splits Rasa data into training and test.csv data.",
    )
    ...
    nlu_split_parser = split_subparsers.add_parser(
        ...
        parents=parents,
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
        help="Performs a split of your NLU data into training and test.csv data "
...
def split_nlu_data(args: argparse.Namespace) -> None:
    """Load data from a file path and split the NLU data into test.csv and train examples.
