...
class TrainingData:
    ...
    def train_test_split(
        ...
        """Split into a training and test.csv dataset,
    ...
    def split_nlu_examples(
        ...
        """Split the training data into a train and test.csv set.
        ...
        # Stratified split: both test.csv and train should have (approximately) the
        ...
        # test.csv and train, so num_classes is the minimum size of either.
        ...
        if int(smaller_split_frac * num_examples) + 1 < num_classes:
            rasa.shared.utils.io.raise_warning(
                ...
                f"an example of each class in both test.csv and train splits and "
        ...
        # in test.csv, and at least one in train, so proportions will be less exact
        ...
        def _split_class(
            ...
            # them. Then adjust so there's at least one example in test.csv and train.
