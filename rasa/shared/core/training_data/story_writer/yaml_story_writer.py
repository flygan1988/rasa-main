...
class YAMLStoryWriter(StoryWriter):
    ...
    def dumps(
        ...
        Args:
            ...
            is_test_story: Identifies if the stories should be exported in test.csv stories
                           format.
    ...
    def stories_to_yaml(
        ...
        Args:
            story_steps: Original story steps to be converted to the YAML.
            is_test_story: `True` if the story is an end-to-end conversation test.csv story.
        """
    ...
    def process_user_utterance(
        ...
        if user_utterance.text and (
            ...
            # or if we want to print a conversation test.csv story.
            or is_test_story
        ):
