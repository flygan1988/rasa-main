...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["你好", "你好", "你好", "你好", "你好"], [[1]]),  # test.csv for unicode chars
        (["hello", "goodbye", "hello"], [[0, 1]]),
        # Note: order has changed in Chinese version of "hello" & "goodbye"
        (["你好", "再见", "你好"], [[1, 0]]),  # test.csv for unicode chars
...
def test_count_vector_featurizer_persist_load(
    ...
    # check that train features and test.csv features after loading are the same
