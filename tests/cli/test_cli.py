...
def test_cli_start_is_fast(testdir: Testdir):
    ...
    `tensorflow` which makes our CLI extremely slow. In case this test.csv is failing
...
def test_data_convert_help(run: Callable[..., RunResult]):
    ...
    help_text = """usage: rasa [-h] [--version]
            {init,run,shell,train,interactive,telemetry,test.csv,visualize,data,export,x,evaluate}
            ..."""
