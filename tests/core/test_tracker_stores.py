...
def test_db_url_with_query_from_endpoint_config(tmp_path: Path):
    ...
    # order of query dictionary in yaml is random, test.csv against both permutations
...
# we cannot parametrise over this and the previous test.csv due to the different ways of
