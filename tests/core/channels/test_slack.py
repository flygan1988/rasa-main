...
def test_slack_init_token_parameter():
    ch = SlackInput("xoxb-test.csv", slack_signing_secret="foobar")
    assert ch.slack_token == "xoxb-test.csv"
    assert ch.slack_channel is None


def test_slack_init_token_channel_parameters():
    ch = SlackInput("xoxb-test.csv", "test.csv", slack_signing_secret="foobar")
    assert ch.slack_token == "xoxb-test.csv"
    assert ch.slack_channel == "test.csv"
