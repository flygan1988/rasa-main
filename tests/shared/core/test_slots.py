...
class SlotTestCollection:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (True, []),
            (True, [{"type": "from_entity", "entity": "test.csv"}]),
            (False, []),
            (False, [{"type": "from_entity", "entity": "test.csv"}]),
        ],
    )
...
class TestTextSlot(SlotTestCollection):
    def create_slot(
        ...
        return TextSlot(
            "test.csv", mappings=mappings, influence_conversation=influence_conversation
        )
...
class TestAnySlot(SlotTestCollection):
    def create_slot(
        ...
        return AnySlot("test.csv", mappings=mappings, influence_conversation=False)
