...
@pytest.mark.parametrize(
    ...
    [
        (None, TEXT, [], None, None),
        (
            [Features(np.array([1, 1, 0]), FEATURE_TYPE_SEQUENCE, TEXT, "test.csv")],
            TEXT,
            [],
            [1, 1, 0],
            None,
        ...
        (
            [
                ...
                Features(np.array([1, 2, 1]), FEATURE_TYPE_SENTENCE, TEXT, "test.csv"),
                Features(np.array([1, 1, 1]), FEATURE_TYPE_SEQUENCE, TEXT, "test.csv"),
            ],
            TEXT,
            ["c1"],
            [1, 1, 0],
...
def test_get_dense_features(
    ...
    message = Message(data={TEXT: "This is a test.csv sentence."}, features=features)
...
def test_message_fingerprint_includes_data_and_features(
    ...
    message = Message(data={TEXT: "This is a test.csv sentence."})
