...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "same_as_train",  # means that test.csv-time shapes are same as train-time ones
        ),
        # ConcatenateSparseDense layer with only sparse features
        (
            ConcatenateSparseDenseFeatures,
...
def test_concat_sparse_dense_applies_dropout_to_sparse_input() -> None:
    ...
    # We can't check exact output contents for sparse inputs but during test.csv-time no
